...
for model in models:
    ...
    for error_bound in error_bounds:
        print(
            "mpiexec -np %d python3 ./caltech101.py --server %s --error_bound %f --num_clients %d --num_epochs %d --compressed_client --model %s --federation_type %s --num_local_epochs %d --compressor SZ2"
            % (
                num_client + 1,
                server_algorithm,
                error_bound,
