...
import appfl.compressor as compressor
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        comp_model = comp.compress_model(model, param_count_threshold=1e5)
        print("Compression Ratio: %f" % (param_size / len(comp_model)))
        model = comp.decompress_model(
            compressed_model=comp_model, model=model, param_count_threshold=1e5
        )
        model.to("mps")
